...
# 원래 decay는 [30, 50, 80]
# 그러나 10번하고 재학습하니까 [20, 40, 70]으로 변환.
...
if __name__ == "__main__":
    if opt.preprocess:
        if opt.data_path.find('RainTrainH') != -1:
            ...
            #prepare_data_Rain12600(data_path=opt.data_path, patch_size=10, stride=10)
